function detected_regions = detect_regions(binary_image, min_region_size, some_threshold, other_threshold, min_region_size2)
            ...
            if binary_image(i, j) == 1
                ...
                if region_size >= min_region_size
                    ...
                    for r = 1:length(detected_regions)
                        ...
                        if are_close_in_horizontal_and_vertical(region, detected_regions(r), some_threshold)
                            % Połączenie regionów
                            detected_regions(r) = merge_regions(detected_regions(r), region);
                            merged = true;
                            break;
                        ...
                        if are_close_in_vertical_and_horizontal(region, detected_regions(r), some_threshold)
                            % Połączenie regionów
                            detected_regions(r) = merge_regions(detected_regions(r), region);
                            merged = true;
                            break;
    ...
    detected_regions = filter_regions(detected_regions, other_threshold, min_region_size2);
end
